...
- **CIC-DDoS2019** (dataset_source=0): 3,661 rows
- **TON_IoT** (dataset_source=1): 35 rows

**Mapping**: `dataset_source` encoding: 0=CIC-DDoS2019, 1=TON_IoT

## Label Distribution
- **Class 0**: 3,686 rows (99.73%)
- **Class 1**: 10 rows (0.27%)
...
## Memory Footprint
- **Estimated memory usage**: 0.06 MB
