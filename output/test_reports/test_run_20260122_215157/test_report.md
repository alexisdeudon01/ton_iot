...
#### tests/test_test_mode.py::test_test_mode_sampling_logic

- **Duration**: 0.002s
- **Input**: N/A
**Validation Criteria (All Passed):**

1. ✅ Assertion: sampled.height == test_row_limit
   - Condition: `sampled.height == test_row_limit`

2. ✅ Assertion: "y" in sampled.columns
   - Condition: `"y" in sampled.columns`

- **Expected Output**: N/A
- **Success Reason**: All validation criteria satisfied: 2/2 passed

#### tests/test_test_mode.py::test_eval_uses_test_split_only

- **Duration**: 0.002s
- **Input**: N/A
**Validation Criteria (All Passed):**

1. ✅ Assertion: test_df.height == 1
   - Condition: `test_df.height == 1`

2. ✅ Assertion: test_df["split"][0] == "test"
   - Condition: `test_df["split"][0] == "test"`

- **Expected Output**: N/A
- **Success Reason**: All validation criteria satisfied: 2/2 passed

#### tests/test_test_mode.py::test_alignment_degraded_fallback

- **Duration**: 0.001s
- **Input**: N/A
**Validation Criteria (All Passed):**

1. ✅ Assertion: len(common) > 0
   - Condition: `len(common) > 0`

- **Expected Output**: N/A
- **Success Reason**: All validation criteria satisfied: 1/1 passed

#### tests/test_test_mode.py::test_prediction_artifact_has_required_columns

- **Duration**: 0.002s
- **Input**: N/A
**Validation Criteria (All Passed):**

1. ✅ Assertion: col in df.columns
   - Condition: `col in df.columns`

- **Expected Output**: N/A
- **Success Reason**: All validation criteria satisfied: 1/1 passed

#### tests/test_test_mode.py::test_run_report_structure

- **Duration**: 0.003s
- **Input**: N/A
**Validation Criteria (All Passed):**

1. ✅ Assertion: "fused_global" in loaded
   - Condition: `"fused_global" in loaded`

2. ✅ Assertion: "cic_RF" in loaded
   - Condition: `"cic_RF" in loaded`
