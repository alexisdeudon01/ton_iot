...
class AHPTopsisFramework:
    ...
    def set_decision_matrix(self, decision_matrix: np.ndarray, alternative_names: List[str] = None):
        """
        ...
        self.alternative_names = alternative_names or [f"Alternative_{i+1}" for i in range(len(decision_matrix))]
