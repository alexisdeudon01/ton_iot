...
def check_irp_compliance():
    ...
    try:
        ...
        expected_dims = ['Detection Performance', 'Resource Efficiency', 'Explainability']
    ...
    try:
        ...
        required_methods = ['set_ahp_comparisons', 'get_weights', 'set_decision_matrix', 'rank_alternatives']
